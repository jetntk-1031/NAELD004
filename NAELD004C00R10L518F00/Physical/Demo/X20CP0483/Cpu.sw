...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <TaskClass Name="Cyclic#2">
    <Task Name="BarcodeRdr" Source="USBBarcodeRdr.BarcodeRdr.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="PullConv" Source="Conv.PullConv.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="MagConv2Cl" Source="MagConv.MagConv2Clp1.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="MagConv2C1" Source="MagConv.MagConv2Clp2.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="MagConv2C2" Source="MagConv.MagConv2Clp3.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="MagConv2C3" Source="MagConv.MagConv2Clp4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  ...
  <TaskClass Name="Cyclic#3">
    ...
    <Task Name="MagRcp1" Source="MagRcp.MagRcp1.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <Task Name="Buffer4" Source="Buffer.Buffer4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <Task Name="USSMEMA4" Source="SMEMA.USSMEMA4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <Task Name="DSSMEMA4" Source="SMEMA.DSSMEMA4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="DSSMEMAA" Source="SMEMA.DSSMEMAA.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="DSSMEMAB" Source="SMEMA.DSSMEMAB.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <Task Name="Pneu2SenPu" Source="Pneu.Pneu2SenPuller.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenI1" Source="Pneu.Pneu2SenInShutter2.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenI2" Source="Pneu.Pneu2SenInShutter3.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenMa" Source="Pneu.MagSafetyBar.Pneu2SenMag1SafetyBar.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenM1" Source="Pneu.MagSafetyBar.Pneu2SenMag2SafetyBar.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenM2" Source="Pneu.MagSafetyBar.Pneu2SenMag3SafetyBar.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenM3" Source="Pneu.MagSafetyBar.Pneu2SenMag4SafetyBar.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <Task Name="DSHermesA" Source="Hermes.DSHermesA.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="DSHermesB" Source="Hermes.DSHermesB.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <Task Name="OpsTravLif" Source="Operations.OpsTravLifLD.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="OpsMagConv" Source="Operations.OpsMagConvLD1.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="OpsMagCon1" Source="Operations.OpsMagConvLD2.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="OpsMagCon2" Source="Operations.OpsMagConvLD3.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="OpsMagCon3" Source="Operations.OpsMagConvLD4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="OpsLifMagL" Source="Operations.OpsLifMagLD.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <Task Name="AGV4" Source="AGVCom.AGV4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenSe" Source="Pneu.SelClamp.Pneu2SenSelClamp1.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenS1" Source="Pneu.SelClamp.Pneu2SenSelClamp2.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenS2" Source="Pneu.SelClamp.Pneu2SenSelClamp3.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Pneu2SenS3" Source="Pneu.SelClamp.Pneu2SenSelClamp4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    ...
    <Task Name="USSOT4" Source="SOT.USSOT4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="DSSOT4" Source="SOT.DSSOT4.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Machine" Source="Machine.Machine.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Machine1" Source="Machine.Machine1.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="Frame" Source="RS232.DVFrame.Frame.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="AutoRcp" Source="AutoRcp.AutoRcp.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="PneuExtSen" Source="Pneu.Trolley.PneuExtSenTrolley.prg" Memory="UserROM" Language="IEC" Debugging="true" />
    <Task Name="PneuExtSe1" Source="Pneu.Trolley.PneuExtSenTrolley2.prg" Memory="UserROM" Language="IEC" Debugging="true" />
  </TaskClass>
  ...
  <Libraries>
    ...
    <LibraryObject Name="NtOPCUA" Source="NtLibraries.NtOPCUA.lby" Memory="UserROM" Language="IEC" Debugging="true" />
