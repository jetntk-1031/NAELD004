...
TYPE
	tyMotionSchILS1FCANDriverOut : 	STRUCT  (*Parameters Output To Driver*)
		usiDriveCtrl_301Esub1 : USINT := 0; (*Jogging Velocity 60FF*)
		usiModeCtrl_301Esub2 : USINT := 0; (*Target Position For Move 607A*)
		intRef16_301Esub5 : INT := 0; (*Homing Method 6098*)
		diRef32_301Esub6 : DINT := 0; (*Mode Of Operation 6060*)
	END_STRUCT;
	tyMotionSchILS1FCANDriverIn : 	STRUCT  (*Parameters Input From Driver*)
		usiModeStat_301Esub3 : USINT := 0; (*Actual Position 6064*)
		uiDriveStat_301Esub4 : UINT := 0; (*Mode of Operation Display 6061*)
		siAct8_301Esub7 : SINT := 0; (*Error Code 603F*)
		diAct32_301Esub8 : DINT := 0; (*Statusword 6041*)
	END_STRUCT;
	tyMotionSchILS1FCANParamOut : 	STRUCT  (*Output Parameters*)
		bPwrOn : BOOL := FALSE; (*Motor Power Turned On*)
		bIsHomed : BOOL := FALSE; (*Motor Homing Done*)
		bInPos : BOOL := FALSE; (*Motor In Position*)
		bStopped : BOOL := FALSE; (*Motor Stopped*)
		...
		diActualPosInUM : DINT := 0; (*Actual Position in um*)
		udiAxisErrID : UDINT := 0; (*Axis Error ID*)
		udiHmMode : UDINT := 0; (*Homing Acceleration*)
		udiHmSpdToSwitch : UDINT := 0; (*Homing Speed During Search For Switch*)
		udiHmSpdFromSwitch : UDINT := 0; (*Homing Speed During Search For Switch*)
		udiHmDistFromSwitch : UDINT := 0; (*Homing Speed During Search For Switch*)
	END_STRUCT;
	tyMotionSchILS1FCANParamInHm : 	STRUCT  (*Input Parameters For Homing*)
		udiHmSpdToSwitchInUMPS : DINT := 50000; (*Homing Start Velocity in um/s*)
		udiHmSpdFromSwitchInUMPS : DINT := 3000; (*Homing Offset Velocity in um/s*)
		udiHmDistFromSwitchInUM : DINT := 500; (*Homing Acceleration in ms*)
	END_STRUCT;
	tyMotionSchILS1FCANFullHm : 	STRUCT  (*Local Variables*)
		usiStep : USINT;
		udiErrStatus : UDINT;
		fbTO : TON := (PT:=T#1000ms);
		fbMotionCANFullPwrOn : fbMotionSchILS1FCANPwrOn;
		fbMotionCANHoming : fbMotionSchILS1FCANHoming;
		fbMotionCANStop : fbMotionSchILS1FCANStop;
	END_STRUCT;
	tyMotionSchILS1FCANParam : 	STRUCT 
		diAutoSpdInUMPS : DINT;
		diBacklashDistInUM : DINT;
	END_STRUCT;
	tyMotionSchILS1FCANFullMovAbs : 	STRUCT  (*Local Variables*)
		bLimitMoveAllowed : BOOL;
		usiStep : USINT;
		udiErrStatus : UDINT;
		diMovePosInUM : DINT;
		fbMotionCANFullHm : fbMotionSchILS1FCANFullHm;
		fbMotionCANMovAbs : fbMotionSchILS1FCANMovAbs;
		fbMotionCANMovAbsBl : fbMotionSchILS1FCANMovAbs;
		fbMotionCANStop : fbMotionSchILS1FCANStop;
		fbMotionCANJog : fbMotionSchILS1FCANJog;
		fbTO : TON;
	END_STRUCT;
END_TYPE
